    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          ...
          {/* Skip weight tracking option */}
          {onSkipWeightTracking && (
            <button
              onClick={onSkipWeightTracking}
              className="w-full mt-2 py-2 px-4 text-gray-600 text-xs font-medium hover:text-gray-800 transition-colors underline"
            >
              🚫 Skip weight tracking for "{exercise.name}"
            </button>
          )}
        </motion.div>
      </motion.div>
